...
<table>
	...
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zibal_API_AMOUNT'); ?></td>
    ...
    ?></td>
        <!--td><?php echo $payment->zibal_response_trx_id;
    ?></td -->
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zibal_API_ERROR_CODE');
    ?></td>
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_zibal_API_ERROR_DESC');
    ?></td>
